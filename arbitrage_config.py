...
# ==================== 开仓条件 ====================
MIN_NET_PROFIT = 0.30  # USDC，最小净利润阈值（扣除开仓费后）
SPREAD_STABILITY_CHECKS = 3  # 价差稳定性检查次数（连续N次采样确认）
...
# ==================== 平仓条件 ====================
# 价差反转平仓
REVERSAL_MIN_SPREAD = 0.20  # USDC，反向价差最小值（触发反转平仓）

# 止盈平仓
TAKE_PROFIT_TARGET = 0.50  # USDC，止盈目标（浮动盈利）

# 超时兜底
POSITION_TIMEOUT_HOURS = 3  # 小时，最大持仓时间（2-4小时兜底）
